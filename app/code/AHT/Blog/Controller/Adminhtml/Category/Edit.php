...
class Edit extends \AHT\Blog\Controller\Adminhtml\Category
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\AHT\Blog\Model\Category::class);
        ...
        $this->_coreRegistry->register('aht_blog_category', $model);
